    ...
    <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
          ...
          <li>
            <div class="message-notif-scroll scrollbar-outer">
              <div class="notif-center">
                <a href="#"><div class="notif-img"><img src="../assets/img/jm_denis.jpg" alt="Profile Img" /></div><div class="notif-content"><span class="subject">Jimmy Denis</span><span class="block">How are you?</span><span class="time">5 minutes ago</span></div></a>
                <a href="#"><div class="notif-img"><img src="../assets/img/chadengle.jpg" alt="Profile Img" /></div><div class="notif-content"><span class="subject">Chad</span><span class="block">Ok, Thanks!</span><span class="time">12 minutes ago</span></div></a>
                <a href="#"><div class="notif-img"><img src="../assets/img/mlane.jpg" alt="Profile Img" /></div><div class="notif-content"><span class="subject">Jhon Doe</span><span class="block">Ready for the meeting today...</span><span class="time">12 minutes ago</span></div></a>
                <a href="#"><div class="notif-img"><img src="../assets/img/talha.jpg" alt="Profile Img" /></div><div class="notif-content"><span class="subject">Talha</span><span class="block">Hi, Apa Kabar?</span><span class="time">17 minutes ago</span></div></a>
              </div>
            </div>
          </li>
          ...
          <li>
            <div class="notif-scroll scrollbar-outer">
              <div class="notif-center">
                ...
                <a href="#"><div class="notif-img"><img src="../assets/img/profile2.jpg" alt="Profile Img" /></div><div class="notif-content"><span class="block">Reza sent you a message</span><span class="time">12 minutes ago</span></div></a>
      ...
      <li class="nav-item topbar-user dropdown hidden-caret">
        <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#">
          <div class="avatar-sm">
            <img src="../assets/img/profile.jpg" alt="Profile Img" class="avatar-img rounded-circle" />
          </div>
          <span class="profile-username"><span class="op-7">Hi,</span> <span class="fw-bold">Phynax</span></span>
        </a>
        <ul class="dropdown-menu dropdown-user animated fadeIn">
          <div class="dropdown-user-scroll scrollbar-outer">
            <li>
              <div class="user-box">
                <div class="avatar-lg">
                  <img src="../assets/img/profile.jpg" alt="Profile Img" class="avatar-img rounded" />
                </div>
                <div class="u-text">
                  <h4>Phynax</h4>
      ...
      <div class="container">
        ...
        <head>
          ...
          <title>Tampilkan Data Tabel</title>
          <style>
            body {
...
function tampilkanTabel($conn, $namaTabel, $idKolom, $searchId = null)
{
  $sql = "SELECT * FROM $namaTabel";
  if ($searchId) {
    $sql .= " WHERE $idKolom = $searchId";
  }
  ...
  if ($result->num_rows > 0) {
    ...
    echo "<h3>Data dari Tabel $namaTabel</h3>";
    ...
    echo "<th>Aksi</th>"; // Kolom untuk aksi
    echo "</tr>";
    ...
    while ($row = $result->fetch_assoc()) {
      ...
      echo "<td>
              <form method='POST' style='display:inline-block;'>
                <input type='hidden' name='tabel' value='$namaTabel'>
                <input type='hidden' name='idKolom' value='$idKolom'>
                <input type='hidden' name='id' value='" . $row[$idKolom] . "'>
    ...
    echo "Tidak ada data yang cocok di tabel $namaTabel.<br>";
  }
}

// Fungsi untuk menghapus data
function hapusData($conn, $namaTabel, $idKolom, $id)
{
  $sql = "DELETE FROM $namaTabel WHERE $idKolom = $id";
...
function editData($conn, $namaTabel, $idKolom, $id, $dataBaru)
{
  // Persiapkan data untuk diperbarui sesuai kebutuhan
  ...
  $sql = rtrim($sql, ", ") . " WHERE $idKolom = $id";
...
// Memproses pilihan tabel dan pencarian
$tabel = isset($_POST['tabel']) ? $_POST['tabel'] : '';
$searchId = isset($_POST['search_id']) ? $_POST['search_id'] : '';

// Menentukan kolom ID yang sesuai untuk masing-masing tabel
switch ($tabel) {
  case 'peminjam':
    $idKolom = 'id_peminjam';
    break;
...
if (isset($_POST['hapus']) && $tabel && $idKolom) {
  $id = $_POST['id'];
  hapusData($conn, $tabel, $idKolom, $id);
}

// Menangani aksi edit
if (isset($_POST['edit']) && $tabel && $idKolom) {
  $id = $_POST['id'];

  // Form input untuk data baru (contoh hanya nama dan email)
  echo "<h3>Edit Data</h3>";
  echo "<form method='POST'>";
  echo "<input type='hidden' name='tabel' value='$tabel'>";
  echo "<input type='hidden' name='idKolom' value='$idKolom'>";
  echo "<input type='hidden' name='id' value='$id'>";
  echo "Nama: <input type='text' name='dataBaru[nama]' required><br>";
  echo "Email: <input type='text' name='dataBaru[email]' required><br>";
  echo "<button type='submit' name='simpan'>Simpan</button>";
  echo "</form>";
}

// Menyimpan data setelah diedit
if (isset($_POST['simpan']) && $tabel && $idKolom) {
  $id = $_POST['id'];
  $dataBaru = $_POST['dataBaru'];
  editData($conn, $tabel, $idKolom, $id, $dataBaru);
}

?>

<!-- Form untuk memilih tabel dan mencari berdasarkan ID -->
<form method="POST" action="">
  ...
  <input type="text" name="search_id" id="search_id" value="<?php echo $searchId; ?>">

  <button type="submit">Tampilkan Data</button>
</form>

<?php
// Menampilkan tabel yang dipilih dan data yang dicari berdasarkan ID (jika ada)
if ($tabel && $idKolom) {
  tampilkanTabel($conn, $tabel, $idKolom, $searchId);
}
        ...
        <footer class="footer">
          <div class="container-fluid d-flex justify-content-between">
            <nav class="pull-left">
              <ul class="nav">
                <li class="nav-item">
                  <a class="nav-link" href="http://www.Phynax.com">
                    Phynax
                  </a>
                </li>
                <li class="nav-item">
            ...
            <div class="copyright">
              ...
              <a href="http://www.Phynax.com">Phynax</a>
            </div>
            <div>
              Distributed by
              <a target="_blank" href="https://Kelompok 3.com/">Kelompok 3</a>.
            </div>
          </div>
        </footer>
      </div>
