...
<html lang="en">
  <head>
    ...
    <title>Perpustakaan SMK STRADA JAKARTA - Kelompok 3</title>
    <meta
    ...
    <link
      rel="icon"
      href="assets/img/kaiadmin/images.jpeg"
      type="image/x-icon"
    />
...
?>
    ...
    <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#" aria-expanded="false">
        ...
        <span class="profile-username">
            ...
            <span class="fw-bold">
                <?php 
                    // Display the user's name from the session or "Guest" if not logged in
    ...
    <ul class="dropdown-menu dropdown-user animated fadeIn">
        <div class="dropdown-user-scroll scrollbar-outer">
            <li>
                <div class="user-box">
                    ...
                    <div class="u-text">
                        ...
                        <p class="text-muted">
                            <?php 
                                // Display the user's email from the session or "No Email" if not set
                                echo isset($_SESSION['user_email']) ? htmlspecialchars($_SESSION['user_email']) : "No Email"; 
                            ?>
                        </p>
            ...
            <li>
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="../tables/login.php">Logout</a>
            </li>
        </div>
    </ul>
</li>
